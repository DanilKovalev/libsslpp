...
TEST_CASE("ChaCha20 test", "[chacha20]")
{
    //https://tools.ietf.org/html/draft-agl-tls-chacha20poly1305-04#section-7
    SECTION("First vector")
    {
        ...
        std::vector<uint8_t> expected = {0x76, 0xb8, 0xe0, 0xad, 0xa0, 0xf1, 0x3d, 0x90,
    ...
    SECTION("Second vector")
    {
        ...
        std::vector<uint8_t> expected = {0x45, 0x40, 0xf0, 0x5a, 0x9f, 0x1f, 0xb2, 0x96,
    ...
    SECTION("Third vector")
    {
        ...
        std::vector<uint8_t> expected = {0xde, 0x9c, 0xba, 0x7b, 0xf3, 0xd6, 0x9e, 0xf5,
    ...
    SECTION("5 vector")
    {
        ...
        std::vector<uint8_t> expected = {0xef, 0x3f, 0xdf, 0xd6, 0xc6, 0x15, 0x78, 0xfb,
